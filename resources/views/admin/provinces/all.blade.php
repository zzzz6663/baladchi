@extends('main.manager')
   ...
   <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        <div class="card-body">
            <form class="dt_adv_search" method="get" action="{{ route('province.index') }}">
                @csrf
                @method('get')
              <div class="row">
                <div class="col-12">
                  <div class="row g-3">
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                      <div class="mb-1">
                          <br>
                    {{-- <a href="{{route('province.create') }}" class="btn rounded-pill btn-secondary">
                        سوال جدید
      ...
      <div class="table-responsive text-nowrap">
        <table class="table ">
          ...
          <tbody class="table-border-bottom-0">
            ...
            <tr>
                ...
                {{-- <td>
                    <span class="{{ $province->active }}"></span>
                    {{ $province->telics->count() }}
                </td> --}}
                
                <td>
                    {{-- <a class="dropdown-item" href="{{ route('province.edit', $province->id) }}"><i class="bx bx-edit-alt me-1"></i> ویرایش</a> --}}
                    {{-- <form  onclick="return confirm('Are you sure?')" action="{{ route('province.destroy',$province->id) }}" method="post">
                      @csrf
        ...
        <div class="row">
            <div class="col-lg-12">
                {{ $provinces->appends(Request::all())->links('admin.section.pagination') }}
            </div>
        </div>
      </div>
    </div>

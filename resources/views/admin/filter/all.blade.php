@extends('main.manager')
   ...
   <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        <div class="card-body">
            <form class="dt_adv_search" method="get" action="{{ route('filter.index') }}">
                @csrf
                @method('get')
              <div class="row">
                <div class="col-12">
                  <div class="row g-3">
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                      <div class="mb-1">
                          <br>
                    <a href="{{route('filter.create') }}" class="btn rounded-pill btn-secondary">
                        فیلتر جدید
                    </a>
                    </div>
                  </div>
        ...
        <table class="table ">
          ...
          <tbody class="table-border-bottom-0">
            ...
            <tr>
                ...
                <td>
                    <a class="dropdown-item" href="{{ route('filter.edit', $filter->id) }}"><i class="bx bx-edit-alt me-1"></i> ویرایش</a>
                    {{-- <form  onclick="return confirm('Are you sure?')" action="{{ route('filter.destroy',$filter->id) }}" method="post">
                      @csrf

...
@section('content')
 <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <h4 class="py-3 breadcrumb-wrapper mb-4">
        <span class="text-muted fw-light"></span>  ویرایش     فیلتر
    {{ $filter->fa }}
      </h4>
      <div class="row">
        <!-- Basic Layout -->
            ...
            <div class="card-body">
              ...
              <form action="{{ route('filter.update' ,$filter->id) }}" method="post" >
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="fa" value="{{ old('fa',$filter->fa) }}" class="form-control" id="basic-default-name" placeholder="  نام    فارسی">
                  </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label" for="basic-default-name">نام   لاتین</label>
                    <div class="col-sm-10">
                      <input type="text" name="en" value="{{ old('en',$filter->en) }}" class="form-control" id="basic-default-name" placeholder="  نام    لاتین">
                    </div>
                  </div>

          ...
          <div class="card-body">
            ...
            <div class="app-brand justify-content-center">
              <a href="index.html" class="app-brand-link gap-2">
                ...
                <span class="app-brand-text demo h3 mb-0 fw-bold">بلدچی</span>
              </a>
            </div>
            <!-- /Logo -->
            @include('main.error')

            <form id="formAuthentication" class="mb-3 fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('admin.check.login') }}" method="POST" novalidate="novalidate">
                @csrf
                @method('post')
              <div class="mb-3 fv-plugins-icon-container">
                <label for="mobile" class="form-label">   همراه</label>
                <input type="tel" class="form-control text-start" dir="ltr" id="mobile" name="mobile" placeholder="    نام کاربری خود را وارد کنید" autofocus="">

                    ...
                    @foreach ($questions as $question)
                        <div class="modal-body">
                            ...
                            @if ($question->type == 'multi')
                                <ul class="q-list">
                                    @if ($question->a1)
                                        <li>
                                            <div class="quest-input">
                                                <input form="qns" type="radio" name="quest" {{ ($answer&& $answer->answer=="a1")?"checked":'' }} value="a1" id="questa1">
                                                <label for="questa1">
                                                    <div class="quest">
                                    ...
                                    @if ($question->a2)
                                        <li>
                                            <div class="quest-input">
                                                <input form="qns" type="radio" name="quest" {{ ($answer&& $answer->answer=="a2")?"checked":'' }} value="a2" id="questa2">
                                                <label for="questa2">
                                                    <div class="quest">
                                    ...
                                    @if ($question->a3)
                                        <li>
                                            <div class="quest-input">
                                                <input form="qns" type="radio" name="quest" {{($answer&& $answer->answer=="a3")?"checked":'' }} value="a3" id="questa3">
                                                <label for="questa3">
                                                    <div class="quest">
                                    ...
                                    @if ($question->a4)
                                        <li>
                                            <div class="quest-input">
                                                <input form="qns" type="radio" name="quest" {{ ($answer&& $answer->answer=="a4")?"checked":'' }} value="a4" id="questa4">
                                                <label for="questa4">
                                                    <div class="quest">
                                    ...
                                    @if ($question->a5)
                                        <li>
                                            <div class="quest-input">
                                                <input form="qns" type="radio" name="quest" {{ ($answer&& $answer->answer=="a5")?"checked":'' }} value="a5" id="questa5">
                                                <label for="questa5">
                                                    <div class="quest">
                            ...
                            <div class="input-label big textarea">
                                ...
                                <textarea name="quest" id="" form="qns"  cols="30" rows="10" placeholder="توضیحات مناسبی برای سوال  تایپ کنید">@if($answer){{  $answer->answer }}
                                    @endif
                                </textarea>
                            </div>
                            @endif
                        ...
                        <div class="search-footer">
                            ...
                            <div class="right-sec">
                                <div class="top-pag">
                                    ...
                                    <form id="qns" action="{{ route('counsel.answer',$counsel->id) }}"method="post">
                                        @csrf
                                        @method('post')

    ...
    <div class="accord-content">
        <div>
            ...
            <div class="input-label">
                ...
                <input type="number" id="floor_min" name="floor__min" class="left filter_class" >
            </div>
            <div class="input-label">
                <label for="floor_max">
                    <span> حداکثر</span>
                ...
                <input type="number" id="floor_max" name="floor__max"  class="left filter_class">
            </div>
        </div>
    </div>
</div>
...
{{--  <div class="accord-box ">
    ...
    <div class="accord-content">
        <div>
            ...
            <div class="input-label">
                <label for="min_function">
                    <span>حداقل</span>
                    <span class="small">(کیلومتر)</span>
                </label>
                <select name="min_function" id="min_function">
                    <option value="1000">هزار </option>
                </select>
            </div>
            <div class="input-label">
                <label for="max_function">
                    <span> حداکثر</span>
                    <span class="small">(کیلومتر)</span>
                </label>
                <input name="max_function" id="max_function" type="text" class="left">
            </div>
        </div>
    </div>
</div>  --}}

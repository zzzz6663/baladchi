<div class="accord-box">
    ...
    <div class="accord-content">
        <div>
            <select name="year_of_construction" id="year_of_construction" class="nice-select filter_class" data-place="  انتخاب کنید">
                ...
                <option value="{{ jdate()->getYear()-30  }}"> حداکثر 30 سال   </option>
            </select>
        </div>
    </div>
</div>

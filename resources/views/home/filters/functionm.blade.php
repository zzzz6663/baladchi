...
{{--  <div class="accord-box">
    ...
    <div class="accord-content spec">
        <div>
            <select name="min_function__min" id="min_function" class="nice-select filter_class" data-place="  از">
                <option value="1000">هزار</option>
                <option value="10000">10 هزار</option>
                <option value="20000">20 هزار</option>
                <option value="30000">30 هزار</option>
                <option value="40000">40 هزار</option>
                <option value="50000">50 هزار</option>
                <option value="60000">60 هزار</option>
                <option value="70000">70 هزار</option>
                <option value="80000">80 هزار</option>
                <option value="90000">90 هزار</option>
                <option value="100000">100 هزار</option>
                <option value="110000">110 هزار</option>
                <option value="120000">120 هزار</option>
                <option value="130000">130 هزار</option>
                <option value="140000">140 هزار</option>
                <option value="150000">150 هزار</option>
                <option value="160000">160 هزار</option>
                <option value="170000">170 هزار</option>
                <option value="180000">180 هزار</option>
                <option value="190000">190 هزار</option>
                <option value="200000">200 هزار</option>
                <option value="200001">200 بیششتر از  هزار</option>
            </select>
        </div>
    </div>
    ...
    <div class="accord-content spec">
        <div>
            <select name="max_function__max" id="max_function" class="nice-select filter_class" data-place="  تا">
                <option value="1000">هزار</option>
                <option value="10000">10 هزار</option>
                <option value="20000">20 هزار</option>
                <option value="30000">30 هزار</option>

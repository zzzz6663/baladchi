<div class="accord-box">
    ...
    <div class="accord-content">
        <div>
            <select name="like_to_exchange" id="like_to_exchange" class="nice-select filter_class" data-place="  انتخاب کنید">
                {{-- <option value="">  لطفا یک گزینه را انتخاب کنید  </option> --}}
                <option value="1">نمایش فقط معاوضعه ها</option>
                <option value="0">حذف فقط معاوضعه ها</option>
            </select>
        </div>
    </div>
</div>

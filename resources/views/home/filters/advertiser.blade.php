                ...
                <ul>
                    <li>
                        <div class="label-containef">
                            <input type="radio" class="filter_class" name="advertiser" value="estate" id="estate" >
                            <label for="estate">
                    ...
                    <li>
                        <div class="label-containef">
                            <input type="radio" class="filter_class" name="advertiser" value="person" id="advertiser">
                    ...
                    <li>
                        <div class="label-containef">
                            <input type="radio" class="filter_class" name="advertiser" checked value="" id="all">
                            <label for="all">
                                <span>همه</span>
                            </label>
                        </div>

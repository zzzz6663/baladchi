    ...
    <div class="accord-content">
        <div>
            <select name="maker" id="maker" class="nice-select select2 filter_class" data-place="  انتخاب کنید">
               ...
               <option value="sonyerisson"> sonyerisson      </option>
               ...
               <option value="farassoo"> farassoo      </option>
               <option value="zte"> zte      </option>
               <option value="veiwsonic"> veiwsonic      </option>
               <option value="zte"> zte      </option>
               ...
               <option value="nartab"> nartab      </option>

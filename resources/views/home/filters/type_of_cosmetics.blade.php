    ...
    <div class="accord-content">
        <div>
            <select name="type_of_cosmetics" id="type_of_cosmetics" class="nice-select filter_class" data-place="  انتخاب کنید">
                ...
                <option value="skin_and_hair_care"> مراقبتی پوست و مو</option>
                <option value="perfume_and_cologne"> عطر و ادکلن</option>
                <option value="tablets_and_herbal_compounds"> قرص و ترکیبات گیاهی</option>

<div class="accord-box">
    ...
    <div class="accord-content">
        <div>
            <select name="amount_of_ram" id="amount_of_ram" class="nice-select filter_class" data-place="  انتخاب کنید">
                {{-- <option value="">  لطفا یک گزینه را انتخاب کنید  </option> --}}
               <option value="not_relevant">مطرح نیست    </option>
               <option value="768mb">768 مگابایت  </option>
               <option value="1gig">1 گیگ </option>
               <option value="1.5gig">1.5 گیگ </option>
               <option value="2gig">2 گیگ </option>
               <option value="3gig">3 گیگ </option>
               <option value="4gig">4 گیگ </option>
               <option value="6gig">6 گیگ </option>
               <option value="8gig">8 گیگ </option>
               <option value="10gig">10 گیگ </option>
               <option value="12gig">12 گیگ </option>
               <option value="16gig">16 گیگ </option>
               <option value="18gig">18 گیگ </option>
            </select>
        </div>
    </div>
</div>

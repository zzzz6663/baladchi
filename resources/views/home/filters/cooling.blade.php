...
<div class="accord-box">
    ...
    <div class="accord-content">
        <div>
            <select name="cooling" id="cooling" class="nice-select filter_class" data-place="  انتخاب کنید">
                <option value="">    انتخاب کنید  </option>
                <option  value="water_cooler">کولر آبی</option>
                <option  value="air_conditioner">کولر گازی</option>
                <option  value="ductsplit">داکت اسپلیت</option>
                <option  value="split">اسپلیت</option>
                <option  value="fan">فن کوئل</option>
            </select>
        </div>
    </div>
</div>

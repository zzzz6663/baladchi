...
<div class="accord-box">
    ...
    <div class="accord-content">
        <div>
            <select name="processor" id="processor" class="nice-select filter_class" data-place="  انتخاب کنید">
                ...
                <option  value="corei9">  core i9  </option>
                <option  value="core2due">    core 2 due  </option>
                <option  value="pentium">pentium  </option>
                <option  value="celeron">celeron  </option>
                <option  value="atom">atom  </option>
                <option  value="reyzen3">reyzen 3  </option>
                <option  value="reyzen5">reyzen 5  </option>
                <option  value="reyzen7">reyzen 7  </option>

@if ($telic)
    ...
    @if ($telic->brands()->where('parent_id', '!=', null)->count() != 0)
            ...
            <div class="accord-content">
                <div>
                    <div class="input-label ">
                        ...
                        {{--  <select name="brand" id="brand" class=" filter_class select_normal" data-place="  انتخاب کنید">
                    </select>  --}}
                        <input type="text" class="filter_class" id="brand" placeholder="">
                        <input type="text" class="filter_class" hidden name="brand" id="brand_id" value="">
                    </div>
                </div>
        ...
        <div class="modal fade new_brand" id="search-modal" tabindex="-1" role="dialog"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="sliding-menu" id="search_parent">
                            <ul id="main_list">
                                @foreach ($categories = App\Models\Brand::where('parent_id', null)->get() as $brand)
                                    <li>
                                        <div class="top">
                                            <span class="cat-item">
                                                <span class="icon">
                                        ...
                                        <div class="sub">
                                            ...
                                            <ul>
                                                @foreach ($brand->childs() as $child)
                                                    <li>
                                                        <div class="sub-slid  {{ $child->childs()->count() > 0 ? '' : 'no_subs' }}"
                                                            data-id="{{ $child->id }}"
                                                            data-name="{{ $child->name }}" data-type="child">
                                                            <span> {{ $child->name }}</span>
                                                            <span
                                                                class="icon  {{ $child->childs()->count() > 0 ? '' : 'dis_none' }}">
                                                                <svg xmlns="http://www.w3.org/2000/svg"

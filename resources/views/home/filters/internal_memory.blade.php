    ...
    <div class="accord-content">
        <div>
            <select name="internal_memory" id="internal_memory" class="nice-select filter_class" data-place="  انتخاب کنید">
                ...
                <option value="32gig">32 گیگ </option>
                <option value="64gig">64 گیگ </option>
                <option value="128gig">128 گیگ </option>
                <option value="256gig">256 گیگ </option>
                <option value="512gig">512 گیگ </option>
                <option value="1tr">1 ترابایت  </option>
            </select>
        </div>
    </div>
</div>

<div class="accord-box">
    ...
    <div class="accord-content spec">
        <div>
            <select name="history" id="min_history" class="nice-select filter_class -select" data-place="  از">
                ...
                <option value="at_least_2_year">        حداقل 2 سال</option>
                <option value="at_least_3_year">        حداقل 3 سال</option>
                <option value="at_least_4_year">        حداقل 4 سال</option>
                <option value="at_least_5_year">        حداقل 5 سال</option>
                <option value="at_least_6_year">        حداقل 6 سال</option>
                <option value="at_least_7_year">        حداقل 7 سال</option>
                <option value="at_least_8_year">        حداقل 8 سال</option>
                <option value="at_least_9_year">        حداقل 9 سال</option>
                <option value="at_least_10_year">        حداقل 10 سال</option>
                <option value="more_than_10_year"> بیشتر از 10 سال</option>
            </select>
        </div>
    </div>

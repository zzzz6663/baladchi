...
<div class="accord-box">
    ...
    <div class="accord-content">
        <div>
            <select name="chassis_status" id="chassis_status" class="nice-select filter_class" data-place="  انتخاب کنید">
                <option value="">    انتخاب کنید  </option>
                <option   value="both_healthy">هردو سالم و پلمپ</option>
                <option  value="hit_back">
                   عقب ضربه خورده
                </option>
                <option    value="painted_back">
                   عقب رنگ شده
                </option>
                <option    value="hit_front">
                   جلو ضربه خورده
                </option>
                <option    value="painted_front">
                   جلو رنگ شده
                </option>
                <option    value="hit_back_painted_front">
                  ،  عقب ضربه خورده
                  جلو رنگ شده

                </option>
                <option    value="hit_front_painted_back">
                   عقب رنگ شده ،
                   جلو ضربه خورده
                </option>

                <option    value="hit_both">
                   هر دو ضربه خورده
                </option>
                <option    value="painted_both">
                   هر دورنگ شده
                </option>
            </select>
        </div>

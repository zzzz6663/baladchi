<div class="accord-box">
    ...
    <div class="accord-content">
        <div>
            <select name="gender_ad_type" id="gender_ad_type" class="nice-select filter_class" data-place="  انتخاب کنید">
                {{-- <option value="">  لطفا یک گزینه را انتخاب کنید  </option> --}}
                <option value="for_girls"> دخترانه</option>
                <option value="for_boys"> پسرانه</option>
            </select>
        </div>
    </div>
</div>

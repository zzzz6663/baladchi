...
<div class="accord-box">
    ...
    <div class="accord-content">
        <div>
            <select name="body_status" id="body_status" class="nice-select filter_class" data-place="  انتخاب کنید">
                <option value="">    انتخاب کنید  </option>
                <option  value="healthy">
                    سالم و بی‌خط و خش
                </option>
                <option  value="minor_scratches">
                    خط و خش جزئی
                </option>
                <option  value="colorless_smoothing">
                    صافکاری بی رنگ
                </option>
                <option  value="discoloration">
                    رنگ شدگی
                </option>
                <option  value="round_color">
                    دور رنگ
                </option>
                <option  value="full_color">
                    تمام نگ
                </option>
                <option  value="by_accident">
                    تصادفی
                </option>
                <option  value="scrap">
                    اوراقی

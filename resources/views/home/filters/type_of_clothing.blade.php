    ...
    <div class="accord-content">
        <div>
            <select name="type_of_clothing" id="type_of_clothing" class="nice-select filter_class" data-place="  انتخاب کنید">
                ...
                <option value="jackets"> ژاکت و پلیور</option>
                <option value="formal_clothes"> لباس مجلسی</option>
                <option value="Wedding_dress"> لباس عروسی</option>
                <option value="suit"> کت و شلوار</option>
                <option value="under_wear"> لباس زیر</option>
                <option value="jacket_overcoat_raincoat"> کاپشن ، پالتو ، بارانی </option>
                <option value="jogging_suit"> لباس ورزشی</option>
                <option value="gloves"> جوراب ، ساق ، دستکش</option>

    ...
    <div id="register-stpes">
        ...
        <div id="register">
            ...
            <div class="input-label big active">
                ...
                <input type="tell" value="{{ old('salary', $user->salary) }}" name="salary" class="number_format" placeholder=" دستمزد شما برای یک ساعت مشاوره">
            </div>
                        ...
                        <span class="edit-cat pointer remove_cat_item" data-id="{{ $ski->id }}">
                            ...
                            <span class="icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M16.0418 3.01976L8.16183 10.8998C7.86183 11.1998 7.56183 11.7898 7.50183 12.2198L7.07183 15.2298C6.91183 16.3198 7.68183 17.0798 8.77183 16.9298L11.7818 16.4998C12.2018 16.4398 12.7918 16.1398 13.1018 15.8398L20.9818 7.95976C22.3418 6.59976 22.9818 5.01976 20.9818 3.01976C18.9818 1.01976 17.4018 1.65976 16.0418 3.01976Z" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M14.9102 4.1499C15.5802 6.5399 17.4502 8.4099 19.8502 9.0899" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>
        ...
        <div class="cat_all_list">
            ...
            <div class="choose-cat pare">
                <span class="cat-item">
                    ...
                    <input type="text" name="catlist[]" value="{{ $user_subset->id }}|subset" hidden>
        ...
        <div class="footer-section">
            <div class="pair-button">
                ...
                <form action=" {{ route('baladchi.form3') }}" method="post">
                    @csrf
                    @method('post')
                    <input id="sebd_da" style="display: {{ $user->subsets()->count() || $user->telics()->count() ? '' : '' }}" class="mid-button blue" type="submit" value="ذخیره اطلاعات ">
                </form>
            </div>
        </div>
        </form>
...
<div class="modal fade new_at_list" id="search-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" style="display: none;">
                        ...
                        <li>
                            ...
                            <div class="sub">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="sub-slid  {{ $subset->telics()->count() > 0 ? '' : 'no_subs_check' }}" data-id="{{ $subset->id }}" data-name="{{ $subset->name }}" data-type="subset">
                                            <span> {{ $subset->name }}</span>
                                            <span class="icon  {{ $subset->telics()->count() > 0 ? '' : 'dis_none' }}">
                                        ...
                                        <div class="sub">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <div data-id="{{ $telic->id }}" data-name="{{ $telic->name }}" data-type="telic" class="sub-slid-end no_subs_check">

            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:right">
                        {{--  @if(!$counsel->active)  --}}
                        <form action="{{ route('counselquestion.destrory',$counselquestion->id) }}" method="post" >
                            @csrf
                            @method('post')
                                ...
                                <button class="no_border">
                                    <span class="icon">
                                        <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M20.9997 7.22998C20.9797 7.22998 20.9497 7.22998 20.9197 7.22998C15.6297 6.69998 10.3497 6.49998 5.11967 7.02998L3.07967 7.22998C2.65967 7.26998 2.28967 6.96998 2.24967 6.54998C2.20967 6.12998 2.50967 5.76998 2.91967 5.72998L4.95967 5.52998C10.2797 4.98998 15.6697 5.19998 21.0697 5.72998C21.4797 5.76998 21.7797 6.13998 21.7397 6.54998C21.7097 6.93998 21.3797 7.22998 20.9997 7.22998Z" fill="currentColor"></path>
                                            <path d="M8.50074 6.22C8.46074 6.22 8.42074 6.22 8.37074 6.21C7.97074 6.14 7.69074 5.75 7.76074 5.35L7.98074 4.04C8.14074 3.08 8.36074 1.75 10.6907 1.75H13.3107C15.6507 1.75 15.8707 3.13 16.0207 4.05L16.2407 5.35C16.3107 5.76 16.0307 6.15 15.6307 6.21C15.2207 6.28 14.8307 6 14.7707 5.6L14.5507 4.3C14.4107 3.43 14.3807 3.26 13.3207 3.26H10.7007C9.64074 3.26 9.62074 3.4 9.47074 4.29L9.24074 5.59C9.18074 5.96 8.86074 6.22 8.50074 6.22Z" fill="currentColor"></path>
                                            <path d="M15.2104 23.25H8.79039C5.30039 23.25 5.16039 21.32 5.05039 19.76L4.40039 9.68995C4.37039 9.27995 4.69039 8.91995 5.10039 8.88995C5.52039 8.86995 5.87039 9.17995 5.90039 9.58995L6.55039 19.66C6.66039 21.18 6.70039 21.75 8.79039 21.75H15.2104C17.3104 21.75 17.3504 21.18 17.4504 19.66L18.1004 9.58995C18.1304 9.17995 18.4904 8.86995 18.9004 8.88995C19.3104 8.91995 19.6304 9.26995 19.6004 9.68995L18.9504 19.76C18.8404 21.32 18.7004 23.25 15.2104 23.25Z" fill="currentColor"></path>
                                            <path d="M13.6581 17.75H10.3281C9.91813 17.75 9.57812 17.41 9.57812 17C9.57812 16.59 9.91813 16.25 10.3281 16.25H13.6581C14.0681 16.25 14.4081 16.59 14.4081 17C14.4081 17.41 14.0681 17.75 13.6581 17.75Z" fill="currentColor"></path>
                                            <path d="M14.5 13.75H9.5C9.09 13.75 8.75 13.41 8.75 13C8.75 12.59 9.09 12.25 9.5 12.25H14.5C14.91 12.25 15.25 12.59 15.25 13C15.25 13.41 14.91 13.75 14.5 13.75Z" fill="currentColor"></path>
                                        </svg>
                                    </span>
                                </button>
...
{{--  @if(!$counsel->active)  --}}
    ...
    <div id="register-stpes">
        ...
        <div id="register">
            ...
            <div class="form">
                <form action="{{ route('panel.new.question',$counsel->id) }}" id="counsel_form" method="post">
                    @csrf
                    @method('post')
                    ...
                    @if($counsel->counselquestions()->count()<5)    <div class="footer-section"  style="justify-content:space-around">
                        <div class="pair-button">
                            ...
                            <button class="mid-button blue pointer" value=" ">
                                ذخیره
                            </button>

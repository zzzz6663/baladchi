                                ...
                                <div class="accord-content">
                                    <div>
                                        ...
                                        <div class="pur-search-form side">
                                            <input type="text" class="text" name="search" id="tag_filter"
                                            ...
                                            <span class="search-button pointer" id="new_tag_filter">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                                    ...
                                                    <path opacity="0.4" d="M16.5 16.5L15 15" stroke="#C7C7C7"
                                        ...
                                        <div class="genr-toggle">
                                            <ul>
                                                <li>
                                                    <div class="label-containef">
                                                        <input type="radio" {{ request('gender') == '' ? 'checked' : '' }}
                                                            name="gender" value="" id="allkind" class="fom_action">
                                                        <label for="allkind">
                                                            <span>همه</span>
                                                        </label>
                                                    </div>
                                                ...
                                                <li>
                                                    <div class="label-containef">
                                                        <input type="radio" {{ request('gender') == 'male' ? 'checked' : '' }}
                                                            name="gender" value="male" id="public" class="fom_action">
                                                        <label for="public">
                                                            <span>مرد</span>
                                                        </label>
                                                    </div>
                                                ...
                                                <li>
                                                    <div class="label-containef">
                                                        <input type="radio"
                                                            {{ request('gender') == 'femail' ? 'checked' : '' }} name="gender"
                                                            value="femail" id="expert" class="fom_action">
                                                        <label for="expert">
                                                            <span>زن</span>
                                                        </label>
                                                    </div>
                                        ...
                                        <ul>
                                            <li>
                                                <div class="checkcontainer">
                                                    <input type="radio" {{ request('reward') == '' ? 'checked' : '' }}
                                                        class="fom_action" name="reward" value="" id="all_r">
                                                    <label for="all_r">
                                                        <span class="check">
                                            ...
                                            <li>
                                                <div class="checkcontainer">
                                                    <input type="radio"
                                                        {{ request('reward') == 'no_reward' ? 'checked' : '' }}
                                                        class="fom_action" name="reward" value="no_reward"
                                                        id="free">
                                                    <label for="free">
                                                        <span class="check">
                                                            <svg width="12" height="9" viewBox="0 0 12 9"
                                            ...
                                            <li>
                                                <div class="checkcontainer">
                                                    <input type="radio"
                                                        {{ request('reward') == 'select_the_best_answer' ? 'checked' : '' }}
                                                        class="fom_action" name="reward" value="select_the_best_answer"
                                                        id="wgift">
                                                    <label for="wgift">
                                                        <span class="check">
                                                            <svg width="12" height="9" viewBox="0 0 12 9"
                                            ...
                                            <li>
                                                <div class="checkcontainer">
                                                    <input type="radio"
                                                        {{ request('reward') == 'divide_reward' ? 'checked' : '' }}
                                                        class="fom_action" name="reward" value="divide_reward"
                                                        id="giftansw">
                                                    <label for="giftansw">
                                                        <span class="check">
                                                            <svg width="12" height="9" viewBox="0 0 12 9"
                                        ...
                                        <ul>
                                            <li>
                                                <div class="radiocontainer">
                                                    <input type="radio" class="fom_action"
                                                        {{ request('degree') == '' ? 'checked' : '' }} name="degree"
                                                        id="all_dd" value="">
                                                    <label for="all_dd">
                                                        <span class="check">
                                                            <svg width="12" height="9" viewBox="0 0 12 9"
                                            ...
                                            <li>
                                                <div class="radiocontainer">
                                                    <input type="radio" class="fom_action"
                                                        ...
                                                        name="degree" id="freex" value="under_high_school">
                                                    <label for="freex">
                                                        <span class="check">
                                                            <svg width="12" height="9" viewBox="0 0 12 9"
                                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <li>
                                                <div class="radiocontainer">
                                                    <input type="radio" class="fom_action"
                                                        ...
                                                        name="degree" id="wgiftx" value="high_school">
                                                    <label for="wgiftx">
                                                        <span class="check">
                                                            <svg width="12" height="9" viewBox="0 0 12 9"
                                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <li>
                                                <div class="radiocontainer">
                                                    <input type="radio" class="fom_action"
                                                        {{ request('degree') == 'master' ? 'checked' : '' }} name="degree"
                                            ...
                                            <li>
                                                <div class="radiocontainer">
                                                    <input type="radio" class="fom_action"
                                                        ...
                                                        name="degree" id="high_master" value="high_master">
                                            ...
                                            <li>
                                                <div class="radiocontainer">
                                                    <input type="radio" class="fom_action"
                                                        {{ request('degree') == 'phd' ? 'checked' : '' }} name="degree"
                                                        id="phd" value="phd">
                                                    <label for="phd">
                                                        <span class="check">
                                                            <svg width="12" height="9" viewBox="0 0 12 9"
                        ...
                        <div class="result-order d-flex align-content-center">
                            ...
                            <div class="genr-toggle">
                                <ul>
                                    <li>
                                        <div class="label-containef">
                                            <input type="radio" {{ request('ordering') == 'oldest' ? 'checked' : '' }}
                                                class="fom_action" form="ba_f" name="ordering" value="oldest" id="oldest"
                                                id="oldest">
                                            <label for="oldest">
                                                <span>قدبمی</span>
                                            </label>
                                    ...
                                    <li>
                                        <div class="label-containef">
                                            <input type="radio" {{ request('ordering') == 'newest' ? 'checked' : '' }}
                                                class="fom_action" form="ba_f" name="ordering" value="newest" id="newest"
                                                id="newest" >
                                            <label for="newest">
                                                <span>جدیدترین</span>
                                            </label>
                                    ...
                                    {{--  <li>
                                        <div class="label-containef">
                                            <input type="radio" {{ request('ordering') == 'favourite' ? 'checked' : '' }}
                                                class="fom_action" form="ba_f" name="ordering" value="favourite" id="favourite"
                                                id="favourite">
                                            <label for="favourite">
                                    ...
                                    <li>
                                        <div class="label-containef">
                                            <input type="radio" {{ request('ordering') == 'point' ? 'checked' : '' }}
                                                class="fom_action" form="ba_f" name="ordering" value="point" id="point"
                                                id="point">
                                            <label for="point">
                                                <span>امتیاز</span>
                                            </label>
                                            ...
                                            <div class="tag-list">
                                                <ul>
                                                    @foreach ($counsel->tags as $tag)
                                                        <li><a href="{{ route('counsels', ['tag_id'=> $tag->id]) }}"
                                                                class="single-tag">{{ $tag->tag }} </a></li>
                                                    @endforeach
